...
def combine():
    ...
    return dict(
        ...
        rust=mat('cmb_rust', '#8A4526', metallic=0.05, roughness=0.90),
        foil=mat('cmb_foil', '#ABA79C', metallic=0.70, roughness=0.48),
        can_red=mat('cmb_can_red', '#A8412A', metallic=0.15, roughness=0.60),
        orange=mat('cmb_orange', '#E0851F', metallic=0.00, roughness=0.62),
...
def reedfolk():
    ...
    return dict(
        ...
        amber=mat('reed_amber', '#CE9223', metallic=0.00, roughness=0.42),
        amber_clear=mat('reed_amber_clear', '#C08E36', metallic=0.00,
                        roughness=0.30, alpha=0.60),
        wax_green=mat('reed_wax_green', '#66782E', metallic=0.00, roughness=0.70),
        honey=mat('reed_honey', '#4A3320', metallic=0.00, roughness=0.68),
        resin=mat('reed_resin', '#C58C1C', metallic=0.00, roughness=0.38),
...
def neutral():
    ...
    return dict(
        ...
        match_head=mat('nt_match_head', '#B03A22', metallic=0.00, roughness=0.72),
        cap_paint=mat('nt_cap_paint', '#AE4A2E', metallic=0.10, roughness=0.62),
        ...
        algae=mat('nt_algae', '#576F22', metallic=0.00, roughness=0.88),
